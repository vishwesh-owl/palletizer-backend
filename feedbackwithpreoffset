...
def getMasterPoints():
    ...
    return pickup, master1, master2, num_layers, num_pallets
...
if __name__ == "__main__":
    pickup_point, master1_point, master2_point, num_layers, num_pallets = getMasterPoints()

    box_coords_1 = [
        [0.05, 0.05, 0], [0.15, 0.05, 0], [0.25, 0.05, 0], [0.35, 0.05, 0], [0.05, 0.15, 0], [0.15, 0.15, 0], [0.25, 0.15, 0], [0.35, 0.15, 0], [0.45, 0.15, 0]  # 0 degrees
    ]

    box_coords_2 = [
        [0.05, 0.05, 0], [0.15, 0.05, 0], [0.25, 0.05, 0], [0.35, 0.05, 0], [0.45, 0.05, 0], [0.05, 0.15, 0], [0.15, 0.15, 0], [0.25, 0.15, 0], [0.35, 0.15, 0], [0.45, 0.15, 0]  # 0 degrees
    ]
    ...
    try:
        ...
        for layer in range(num_layers):
            for i in range(max_boxes):
                ...
                if num_pallets == 2 and i < len(box_coords_2):
                    box = box_coords_2[i]

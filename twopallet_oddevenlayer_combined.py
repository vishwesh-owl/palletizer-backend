...
def getMasterPoints():
    ...
    return pickup, master1, master2, num_layers, num_pallets, layer_config
...
if __name__ == "__main__":
    pickup_point, master1_point, master2_point, num_layers, num_pallets, layer_config = getMasterPoints()

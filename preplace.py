...
def calculate_pre_placement_point(box_coords, largest_dimension, current_box_index, master_point):
    ...
    pre_place_z = master_point[2] + z_offset  # Apply z offset wrt master TCP z-coordinate
    ...
    try:
        ...
        for layer in range(num_layers):
            for i, box in enumerate(box_coords):
                ...
                pre_place = calculate_pre_placement_point(box_coords, largest_dimension, i, master_point)
